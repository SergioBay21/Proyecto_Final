 ...
 * @author Sapón Pérez
 */
public class ventas_detalle___ {
    Conexion cn;
    int id_venta, id_producto, p_unitario,existencia;
    String cantidad;

    public ventas_detalle___(){};

    public ventas_detalle___(int id_venta, int id_producto, int p_unitario, int existencia, String cantidad) {
